...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        { title: 'توصيف منتج', icon: <FaPlus />, path: '/warehouses/add-product' },
        { title: 'إدارة المنتجات', icon: <FaBox />, path: '/warehouses/manage-products' },
        { title: 'إضافة مخزن', icon: <FaWarehouse />, path: '/warehouses/add-warehouse' },
        { title: ' المجموعات', icon: <FaFolder />, path: '/warehouses/manage-categories' },
        { title: 'تحويل بين المخازن', icon: <FaExchangeAlt />, path: '/warehouses/transfer' },
        { title: 'جرد المخازن', icon: <FaList />, path: '/warehouses/inventory' },
        { title: 'إدارة المخازن', icon: <FaCog />, path: '/warehouses/manage' },
