...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        { title: 'توصيف منتجات', icon: <FaPlus />, path: '/warehouses/add-product' },
        ...
        { title: 'إدارة الوحدات', icon: <FaCubes />, path: '/warehouses/units' },
        { title: 'بين المخازن تحويل', icon: <FaExchangeAlt />, path: '/warehouses/transfer' },
